        ...
        loginbtn.setOnClickListener(new View.OnClickListener() {
            @Override
                ...
                if(phoneTxt.isEmpty() || passwordTxt.isEmpty()){
                    Toast.makeText(Login.this,"Please put in phone" , Toast.LENGTH_SHORT).show();
                }
                else{
                    ...
                    databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            //check if email exist in firebase database
                            if(snapshot.hasChild(phoneTxt)){
                                ...
                                if(getPassword.equals(passwordTxt)){
                                    ...
                                    //open Trainee activity
                                    startActivity(new Intent(Login.this, Trainee_Page.class));}}
                                    else{
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                if(snapshot.hasChild(phoneTxt)){
                                                    ...
                                                    if(getPassword.equals(passwordTxt)){
                                                        ...
                                                        startActivity(new Intent(Login.this,Trainee_Registration.class));
                                                    }
...
//                            }
        ...
        registerNowBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //Open Register activity options
